...
# ntu_home classes added
home_classes = [1, 2, 3, 8, 9, 11, 12, 27, 28, 32, 37, 41, 43, 44, 45, 46, 47, 48, 69, 70, 74, 85, 103, 104, 105]
...
def gendata(file_list, out_path, ignored_sample_path, benchmark, part):
    ...
    for folder, filename in sorted(file_list):
        ...
        if issample:
            ...
            sample_label.append(home_classes.index(action_class))   # to 0-indexed
...
if __name__ == '__main__':
    ...
    parser.add_argument('--part1-path', default='../data/nturgbd_raw/ntu_home_skeletons/')
    parser.add_argument('--part2-path', default='../data/nturgbd_raw/ntu_home_skeletons/')
    parser.add_argument('--ignored-sample-path',
                        default='../data/nturgbd_raw/NTU_RGBD120_samples_with_missing_skeletons.txt')
    parser.add_argument('--out-folder', default='../data/ntuhome/')
